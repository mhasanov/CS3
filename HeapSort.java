...
public class HeapSort {
	 ...
	 * @throws IOException              if there was an issue with processing the
	 *                                  files.
	 * @throws IllegalArgumentException if the number of arguments were not 3.
	 */
	public static void main(String[] args) throws IOException {
		if (args.length != 3) {
			throw new IllegalArgumentException(
					"Exactly three arguments needed: file-input, number of buffers, file-output");
		}
	 ...
	 * @param finalTime  Amount of time for the sorting.
	 * @param fileName   Statistics File.
	 * @param bufferPool This objects statistics are printed.
	 * @throws IOException when there is a problem with the file I/O.
	 */
	public static void displayInfo(File resultFile, long finalTime, String fileName, BufferPool bufferPool)
			throws IOException {
	...
	/**
	 * This method will sort the binary file using the heapsort algorithm. Also, it
	 * will store information about the sorting process.
	 *
	 * @param fileName    Binary File that will be sorted.
	 * @param noOfBuffers Buffers provided in the command line.
	 * @param outputFile  Statistics will be written to this file.
	 * @throws IOException When there is an issue with file I/O.
	 */
	public static void processInfo(String fileName, String noOfBuffers, String outputFile) throws IOException {
